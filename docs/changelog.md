...
### 改动
- 移除了 Flask 后端与相关脚本，项目转为纯前端架构
- 清理了 axios 依赖与 `/api` 代理配置，简化前端构建
- 对 README、用户/开发指南、前端 README 以及项目教程进行全面更新，统一使用“纯前端 + 可选 Serverless”描述，并改为 `start_browser.bat` / `start_all.sh` 启动方式
- 调整启动/停止脚本，仅保留前端开发服务器
